...
const validarPassword2 = () => {
	...
	if(inputPassword1.value !== inputPassword2.value){
		...
		document.querySelector(`#grupo_password2 .formulario__input-error`).classList.add('formulario_input-error-activo');
		...
		document.querySelector(`#grupo_password2 .formulario__input-error`).classList.remove('formulario_input-error-activo');
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.usuario && campos.nombre && campos.password && campos.correo && campos.telefono && terminos.checked ){
		...
		document.getElementById('formulario_mensaje-exito').classList.add('formulario__mensaje-exito-activo');
		setTimeout(() => {
			document.getElementById('formulario_mensaje-exito').classList.remove('formulario__mensaje-exito-activo');
		}, 5000);
